...
xhr.onerror = () => {
  console.error(
    "Network error while uploading receipt."
  );

  toast.error(
    "Unable to connect to the Expense Claim API."
  );
...
return ( <div className="space-y-6">
  ...
  >
    ...
    <p className="mx-auto mt-2 max-w-md text-sm text-base-content/60">
      Upload a receipt image or PDF and our
      AI-powered document processing service
      will extract the vendor, amount, and
      expense date automatically.
    </p>
    ...
    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-base-content/60">
          You can submit your expense claim
          manually without using AI processing.
        </p>
      </div>
